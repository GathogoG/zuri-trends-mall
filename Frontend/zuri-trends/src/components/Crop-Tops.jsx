...
const CropTops = () => {
  const [cropTops, setCropTops] = useState([
    { id: 1, title: 'Crop Top 1', name: 'Product 1', price: 'KES 2,000.00', imgSrc: 'https://m.media-amazon.com/images/I/517X315L1gL.jpg' },
    { id: 2, title: 'Crop Top 2', name: 'Product 2', price: 'KES 2,500.00', imgSrc: 'https://i5.walmartimages.com/asr/4c6efd67-9103-4b37-9835-6b8c713ad0e2.b520f681070497c4dbf5ba190a223eb0.jpeg?odnHeight=432&odnWidth=320&odnBg=FFFFFF' },
